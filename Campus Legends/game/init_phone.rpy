...
label init_phone:
    python:
        ...
        if not phone_state.initialized:
            ...
            # TEXTS
            # --------------------------------------------
            sienna_m1 = SMS(sienna, "What's up?")
            ...
            player_r4 = player_r2.chain("Picture?", npc_image="images/phone/jeff.png")
            player_r4a = player_r2a.chain("Send a picture", npc_image="images/phone/jeff.png")
